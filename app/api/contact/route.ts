...
export async function POST(req: NextRequest) {
  try {
    ...
    const { firstName, lastName, email, phone, eventType, eventDate, hours, venue, message } = body
        ...
        <div style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; color: #1A1A1A;">
          ...
          <div style="padding: 40px 30px; background: #FAF8F5;">
            ...
            <table style="width: 100%; border-collapse: collapse;">
              ...
              <tr><td style="padding: 10px 0; border-bottom: 1px solid #E8E4DE; color: #8B8B8B;">Hours Needed</td><td style="padding: 10px 0; border-bottom: 1px solid #E8E4DE;">${hours || 'Not sure yet'}</td></tr>
      ...
      html: `
        <div style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; color: #1A1A1A;">
          ...
          <div style="padding: 40px 30px; background: #FAF8F5;">
            ...
            <p style="color: #8B8B8B; line-height: 1.8; margin-bottom: 20px;">
              We received your inquiry and will be in touch within 24 hours to confirm availability and answer any questions.
            </p>
            <p style="color: #8B8B8B; line-height: 1.8; margin-bottom: 30px;">
              In the meantime, feel free to browse our packages at theframehouse.online/packages.
            </p>
